...
Constant NKEY__TX     = "С = вниз";
Constant PKEY__TX     = "П = вверх";
Constant QKEY1__TX    = "В = возврат";
Constant QKEY2__TX    = "В = возврат";
Constant RKEY__TX     = "RETURN = выбор";

Constant NKEY1__KY    = 'С';
Constant NKEY2__KY    = 'с';
Constant PKEY1__KY    = 'П';
Constant PKEY2__KY    = 'п';
Constant QKEY1__KY    = 'В';
Constant QKEY2__KY    = 'в';
