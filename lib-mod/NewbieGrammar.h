...
[ TooPoliteSub;
	"Игра не понимает вежливые формулировки, такие как: @<<Пожалуйста,
	открой дверь@>>, - или: @<<Будь добр, открой коробку@>>.
	Начинайте команды с глагола в повелительном наклонении, и они будут
	исполняться точнее.";
];
...
[ ExitsSub;
	"Если вы осмотритесь (ОСМОТРЕТЬСЯ, ОСМ), то заметите указание сторон света,
	по которым можно пройти в другие комнаты (ЮГ, СЕВЕРО-ВОСТОК и т.д.).";
];
